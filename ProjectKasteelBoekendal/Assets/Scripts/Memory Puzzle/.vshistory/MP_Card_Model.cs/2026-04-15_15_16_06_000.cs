...
public class MP_Card_Model : MonoBehaviour
{
    ...
    {
        Debug.Log($"[CARD CLICK] {name} clicked. isSelected = {isSelected}, matchKey = {matchKey}");

        if (cardController == null)
        {
            Debug.LogError($"[CARD CLICK] cardController is NULL on {name}!");
            return;
        }
    ...
    public void Show()
    {
        ...
        // IMPORTANT: Do NOT set isSelected here
    }
